...
extern struct wsrep_service_st {
  ...
  void                        (*wsrep_thd_auto_increment_variables_func)(MYSQL_THD thd, unsigned long long *offset, unsigned long long *increment);
  void                        (*wsrep_set_load_multi_commit_func)(MYSQL_THD thd, bool split);
  bool                        (*wsrep_is_load_multi_commit_func)(const MYSQL_THD thd);
...
void wsrep_set_load_multi_commit(MYSQL_THD thd, bool split);
bool wsrep_is_load_multi_commit(const MYSQL_THD thd);
